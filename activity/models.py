...
class Rentprice(models.Model):
    ...
    snowboard1_price = models.IntegerField(verbose_name='单板单价', default=0)
    snowboard1_deposit = models.IntegerField(verbose_name='单板押金', default=0)
    snowboard2_price = models.IntegerField(verbose_name='双板单价', default=0)
    snowboard2_deposit = models.IntegerField(verbose_name='双板押金', default=0)
