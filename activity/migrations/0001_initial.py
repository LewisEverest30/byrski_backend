    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gift', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='activity.skiresort', verbose_name='对应的滑雪场')),
            ],
            options={
                'verbose_name': '滑雪场摄影',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('schedule_full', models.TextField(null=True, verbose_name='行程安排(详细说明)')),
