...
urlpatterns = [
    ...
    path('check_student', check_student.as_view()),
    path('get_user_basic_info', get_user_basic_info.as_view()),
    path('update_user_basic_info', update_user_basic_info.as_view()),

    path('get_tickets_of_homepage_activity', get_tickets_of_homepage_activity.as_view()),
    ...
    path('get_boardingloc', get_boardingloc.as_view()),

    path('create_ticket_order', create_ticket_order.as_view()),
    path('get_itinerary_of_certain_order', get_itinerary_of_certain_order.as_view()),
    path('get_all_itinerary', get_all_itinerary.as_view()),
    path('get_detail_of_certain_itinerary', get_detail_of_certain_itinerary.as_view()),
    path('get_available_boardingloc_of_certain_itinerary', get_available_boardingloc_of_certain_itinerary.as_view()),
    path('try_refund_ticket_order', try_refund_ticket_order.as_view()),
        path('select_new_boardingloc', select_new_boardingloc.as_view()),
        path('set_go_boarded', set_go_boarded.as_view()),
        path('set_return_boarded', set_return_boarded.as_view()),
        path('get_activity_guide_step', get_activity_guide_step.as_view()),
        path('next_activity_guide_step', next_activity_guide_step.as_view()),
        path('set_activity_guide_finished', set_activity_guide_finished.as_view()),
