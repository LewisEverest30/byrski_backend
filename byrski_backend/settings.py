...
CRONJOBS = [
    ...
    ('1 0 * * *', 'order.cron.set_activity_expire', '>> ' + os.path.join(os.path.dirname(BASE_DIR), 'logs/set_activity_expire.log')), # 00:01
    ('2 0 * * *', 'order.cron.set_activity_locked', '>> ' + os.path.join(os.path.dirname(BASE_DIR), 'logs/set_activity_locked.log')), # 00:01
]
